...
VALUES 
	...
	(3, 16, 'Work'),
	(8, 6, 'Home'),
	(19, 17, 'Second home for those things you dont deliver to your house.'),
	(20, 15, 'House'),
	(19, 10, 'Work'),
	(8, 6, 'House'),
	(3, 11, 'Work'),
...
VALUES 
	...
	(1, 'Zebra Rock', 'Black and white striped rock. Its like camo for the 1800s, you know before colours were invented.', 108.92, GETDATE(), 5),
	(1, 'Giraffe Rock', 'Rock with loooooong neck. Male giraffes eat leaves closer to the top of the tree.', 578.76, GETDATE(), 5),
	(2, 'Glass eyes', 'Glass beads. You can use them as eyes. You can use them to slingshot the house windows.', 315.55, GETDATE(), 5),
	(2, 'Googly eyes', 'The eyes they google. Not that kind of google... no stop asking me things.', 633.04, GETDATE(), 5),
	(3, 'Angry Brow', 'Angry shaped eyebrows. For your everyday tantrum needs.', 171.68, GETDATE(), 5),
	(3, 'Happy Brow', 'Happy shaped eyebrows. Dont worry, Be happy.', 635.74, GETDATE(), 5),
	(3, 'Sad Brow', 'Sad shaped eyebrows. Tears not included.', 859.27, GETDATE(), 5),
	(3, 'Skeptical Brow', 'Sus shaped eyebrows. Amogus', 119.26, GETDATE(), 5),
	...
	(6, 'Leash', 'Leash for walking your rock. Yes, rocks need exercise too. ', 696.27, GETDATE(), 5),
	...
	(9, 'Ears', 'Ears what more can I say. You wouldnt hear without these anyway.', 632.83, GETDATE(), 5),
